...
| **msc-dev-code-and-qa-test-coverage-validator** | `/msc-dev-code-and-qa-test-coverage-validator MSC-1234` | `reports/{KEY}-{timestamp}-{TZ}.html` — `build_coverage_report.py`; CI + Dev tests columns; branch-only stories; passport/ESS LADR |
